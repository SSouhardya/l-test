...
Rscript ~/reproducibility/combine_CI_results.R par_unadj_ci_correlation.RData,50,0,correlation
Rscript ~/reproducibility/combine_CI_results.R par_unadj_ci_sparsity.RData,500,0,sparsity
